...
import com.example.androidkotlin.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
//        super.onBackPressed()
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.example.androidkotlin/" + R.raw.press_start)
