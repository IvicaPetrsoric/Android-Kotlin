...
import com.example.androidkotlin.databinding.ActivityBmiBinding
...
//            } else {
//                Toast.makeText(this, "Please ener valid values.", Toast.LENGTH_LONG).show()
//            }
            calculateUnits()
        }
    }
