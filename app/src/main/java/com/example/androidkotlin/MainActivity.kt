...
import com.example.androidkotlin.databinding.DialogUpdateBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupListOfDataIntoRecyclerView(employeesList: ArrayList<EmployeeEntity>,
                                                eployeeDao: EmployeeDao) {
        if (employeesList.isNotEmpty()) {
            val itemAdapter = ItemAdapter(employeesList,
                    {
                        updateId ->
                        updateRecordDialog(updateId, eployeeDao)

                    },
                     {
                        deleteId ->
                            deleteRecordAlertDialog(deleteId, eployeeDao)
                    }
